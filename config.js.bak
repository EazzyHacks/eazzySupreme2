...
global.author = '𝗔𝘀𝗵 𝗕𝗼𝘁 🤍'
global.stickpack = '𝗙𝗲𝗹𝗶𝗰𝗶𝗱𝗮𝗱𝗲𝘀 𝗛𝗶𝗰𝗶𝘀𝘁𝗲 𝗨𝗻 𝗦𝘁𝗶𝗰𝗸𝗲𝗿 𝗖𝗼𝗻 🤍'
global.stickauth = '𝗔𝘀𝗵 𝗕𝗼𝘁 🤍'
global.wm = '𝗔𝘀𝗵 𝗕𝗼𝘁𝘁 🤍'
global.dev = '𝐒𝐨𝐟𝐭𝐰𝐚𝐫𝐞 𝐁𝐲 𝗔𝘀𝗵 𝗕𝗼𝘁'
global.wait = '*𝐏𝐨𝐫 𝐟𝐚𝐯𝐨𝐫 𝐚𝐠𝐮𝐚𝐫𝐝𝐞 𝐮𝐧 𝐦𝐨𝐦𝐞𝐧𝐭𝐨\n\n> 𝗔𝘀𝗵 𝗕𝗼𝘁 🤍*'
global.botname = '𝗔𝘀𝗵 𝗕𝗼𝘁 🤍'
global.textbot = `𝐓𝐞𝐜𝐧𝐨𝐥𝐨𝐠𝐢𝐬 𝐛𝐲 𝗔𝘀𝗵 𝗕𝗼𝘁 🤍`
global.dev = '𝐒𝐨𝐟𝐭𝐰𝐚𝐫𝐞 𝐁𝐲 𝗔𝘀𝗵 𝗕𝗼𝘁 🤍'
global.listo = '*𝐄𝐱𝐢𝐭𝐨*'
global.namechannel = '𝗔𝘀𝗵 𝗕𝗼𝘁 🤍'
